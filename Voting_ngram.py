...
vclf_pure = VotingClassifier(estimators=[('NB_pure', pure_clf_nb), ('DT_pure', pure_clf_DT)], voting='soft', weights=[2, 1], verbose=True)
...
vclf_w = VotingClassifier(estimators=[('NB_WP', clf_w_nb), ('DT_WP', clf_w_DT)], voting='soft', weights=[2, 1], verbose=True)
...
vclf_q = VotingClassifier(estimators=[('NB_QP', clf_q_nb), ('DT_QP', clf_q_DT)], voting='soft', weights=[2, 1], verbose=True)
...
vclf_total = VotingClassifier(estimators=[('NB_total', clf_nb), ('DT_total', clf_DT)], voting='soft', weights=[2, 1], verbose=True)
